    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <#if authenticated>
            ...
            <form action="/logout" class="form-inline my-2 my-lg-0" method="post">
                ...
                <button class="btn btn-outline-warning my-2 my-sm-0" type="submit"><@spring.message "logout.message"/></button>
            </form>
        <#else>
            <form action="/login" class="form-inline my-2 my-lg-0">
                <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><@spring.message "login.message"/></button>
            </form>
        </#if>
    </div>
</nav>